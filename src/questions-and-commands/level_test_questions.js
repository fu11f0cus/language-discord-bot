...
export const eng_questions = [
    ...
    new CustomQuestionBuilder.Boolean()
    .setValue('"He had been studying English for two years when he moved to London" - это предложение в Past Perfect Continuous времени.')
    .setCorrectAnswer('true'),
    new CustomQuestionBuilder.Boolean()
    .setValue('Английский алфавит содержит 26 букв')
    .setCorrectAnswer('true'),
    new CustomQuestionBuilder.Boolean()
    .setValue('"The book, which I read, was very interesting" - это пример ограничительной придаточной части')
    .setCorrectAnswer('true'),
    new CustomQuestionBuilder.Boolean()
    .setValue('Правильный порядок слов в вопросительном предложении: "You are coming to the party?"')
    .setCorrectAnswer('false'),
    new CustomQuestionBuilder.Boolean()
    .setValue('"I could care less" - это правильное выражение, обозначающее, что вас не особенно волнует что-то.')
    .setCorrectAnswer('false'),
];

export const eng_trueFalse = [
    {
...
export const eng_level_test = [
    ...
    {
        question: "He said that his friends ... to speak to him after they lost the football match",
        option1: "didn't want",
        option2: "weren't",
    ...
    {
        question: "She ... for the cat for two days when she finally found it in the garage",
        option1: "looked",
    ...
    {
        question: "We won't catch the plane ... we leave home now! Please hurry up!",
        option1: "if",
        option2: "unless",
        option3: "except",
        correct: "unless"
    ...
    {
        question: "Do you think you ... with my mobile phone soon? I need to make a call",
        option1: "finish",
    ...
    {
        question: "You may not like the cold weather here, but you'll have to ..., I'm afraid",
        option1: "tell it off",
